...
describe('ProductionOrdersController', () => {
  ...
  it('declares permission keys for every production-order route', () => {
    ...
    const dedicatedPermissionRoutes = new Map([
      ...
      [
        'findFiltrationChecks',
        PRODUCTION_ORDER_PERMISSIONS.FILTRATION_CHECK_READ,
      ],
      [
        'createFiltrationCheck',
        PRODUCTION_ORDER_PERMISSIONS.FILTRATION_CHECK_CREATE,
      ],
      [
        'updateFiltrationCheck',
        PRODUCTION_ORDER_PERMISSIONS.FILTRATION_CHECK_UPDATE,
      ],
      [
        'deleteFiltrationCheck',
        PRODUCTION_ORDER_PERMISSIONS.FILTRATION_CHECK_DELETE,
      ],
      [
        'uploadProductionGuide',
        PRODUCTION_ORDER_PERMISSIONS.UPLOAD_PRODUCTION_GUIDE,
      ],
      [
        'findMaterialSummaryById',
        PRODUCTION_ORDER_PERMISSIONS.MATERIAL_SUMMARY_READ,
      ],
      [
        'findMaterialSummaries',
        PRODUCTION_ORDER_PERMISSIONS.MATERIAL_SUMMARY_READ,
      ],
      [
        'createMaterialSummary',
        PRODUCTION_ORDER_PERMISSIONS.MATERIAL_SUMMARY_CREATE,
      ],
      [
        'updateMaterialSummary',
        PRODUCTION_ORDER_PERMISSIONS.MATERIAL_SUMMARY_UPDATE,
      ],
      [
        'deleteMaterialSummary',
        PRODUCTION_ORDER_PERMISSIONS.MATERIAL_SUMMARY_DELETE,
      ],
      [
        'getSteamSterilizationCheckImage',
        PRODUCTION_ORDER_PERMISSIONS.STEAM_STERILIZATION_READ,
      ],
      [
        'findSteamSterilizationCheckById',
        PRODUCTION_ORDER_PERMISSIONS.STEAM_STERILIZATION_READ,
      ],
      [
        'findSteamSterilizationChecks',
        PRODUCTION_ORDER_PERMISSIONS.STEAM_STERILIZATION_READ,
      ],
      [
        'createSteamSterilizationCheck',
        PRODUCTION_ORDER_PERMISSIONS.STEAM_STERILIZATION_CREATE,
      ],
      [
        'updateSteamSterilizationCheck',
        PRODUCTION_ORDER_PERMISSIONS.STEAM_STERILIZATION_UPDATE,
      ],
      [
      ...
      ['addDateCheckImages', PRODUCTION_ORDER_DATE_CHECK_PERMISSIONS.UPDATE],
