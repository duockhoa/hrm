...
import ApplicationDetail from "@/components/detail-application/detail-application";
import ApplicationDetailHeader from "@/components/header-application-detail/header-application-detail";
import ApplicationUsersInline from "@/components/inline-application-users/inline-application-users";
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
