...
import { HeaderDetailFinishedProductLot } from "@/features/finished-product-production-orders";
...
export default function DetailLotPage() {
  ...
  useEffect(() => {
    if (productionOrderLines) {
      console.log(productionOrderLines);
    }
      ...
      <ResizablePanelGroup>
        ...
        >
          {showMixingRecord ? (
            ...
            <>
              <HeaderDetailFinishedProductLot lot={data} />
