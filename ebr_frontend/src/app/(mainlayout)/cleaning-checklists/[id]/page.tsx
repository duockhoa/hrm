...
import { ProductionWorkshopCleaningChecklistsPage } from "@/features/production-workshop-cleaning-checklists";
...
import CleaningChecklistsRoutePage from "../page";

export default function DetailCleaningChecklistsPage() {
      ...
      <ResizablePanelGroup>
        ...
        >
          <div className="flex flex-col items-center gap-2 rounded md:gap-4">
            <ProductionWorkshopCleaningChecklistsPage
