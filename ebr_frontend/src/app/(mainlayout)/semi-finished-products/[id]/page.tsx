...
import { DetailSemiFinishProductHeader } from "@/features/semi-finished-products";
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
...
import SemiFinishProducts from "../page";

export default function DetailSemiFinishedProductPage() {
      ...
      <ResizablePanelGroup>
        ...
        >
          {isMixingTemplatesOpen ? (
            ...
            <>
              <DetailSemiFinishProductHeader
                semiFinishProduct={data}
