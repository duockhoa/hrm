...
export default function FormBottleLeakTightnessCheck({
  productionOrderId,
  itemCode,
  productionSpecification,
  dosageFormStage = "Lọ",
  title = "Kiểm tra độ kín lọ",
  requirementText,
  ...
  const { data: fetchedProductionSpecification } = useSWR(
    !requirementText && !emptyRequirement && !productionSpecification && itemCodeValue
                  ...
                  <div className="space-y-2">
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        placeholder={emptyRequirement ? "" : "Không được rò rỉ"}
                        {...field}
                      />
                    </FormControl>
                  </div>
