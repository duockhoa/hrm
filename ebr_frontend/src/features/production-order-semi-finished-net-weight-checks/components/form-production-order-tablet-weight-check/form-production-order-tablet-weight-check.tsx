...
const formSchema = z.object({
  ...
  unit_1_net_weight: requiredWeightText("khối lượng viên 1"),
  unit_2_net_weight: optionalWeightText("khối lượng viên 2"),
  unit_3_net_weight: optionalWeightText("khối lượng viên 3"),
  unit_4_net_weight: optionalWeightText("khối lượng viên 4"),
  unit_5_net_weight: optionalWeightText("khối lượng viên 5"),
  unit_6_net_weight: optionalWeightText("khối lượng viên 6"),
  unit_7_net_weight: optionalWeightText("khối lượng viên 7"),
  unit_8_net_weight: optionalWeightText("khối lượng viên 8"),
  unit_9_net_weight: optionalWeightText("khối lượng viên 9"),
  unit_10_net_weight: optionalWeightText("khối lượng viên 10"),
});
...
export default function FormProductionOrderTabletWeightCheck({
  productionOrderId,
  itemCode,
  productionSpecification,
  title = "Kiểm tra khối lượng viên nén",
  unit = "mg",
  unitLabel = unit,
  ...
  const hasProductionSpecificationFromOrder =
    hasSpecificationLimits(productionSpecification);
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      ...
      toast.error(
        getErrorMessage(error, "Không thể lưu kiểm tra khối lượng viên nén."),
      );
